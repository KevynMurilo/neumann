...
import beer from "../../assets/icon.png";
...
const OpenCalculate = ({ isOpen, setModalOpen }) => {
    ...
    if (isOpen) {
        return (
            <>
            {/*DESKTOP*/}
            <div className="hidden fixed top-0 bottom-0 left-0 right-0 lg:flex items-center justify-center z-50 overflow-auto overflow-y-auto" style={{ background: 'rgba(0,0,0,0.7)' }}>
                ...
                <div className="flex flex-col">
                    <div className="flex items-stretch justify-between mb-8">
                        <div className="flex flex-col items-start px-5 flex-grow" style={{ flexBasis: 0 }}>
                            <div className="bg-gold w-20 h-20 mt-5 rounded-full flex justify-center items-center mb-5">
                    ...
                    <div className="flex flex-col justify-start items-start mt-12">
                        ...
                        <button className="lg:w-52 lg:h-auto mt-2 p-6 bg-gold rounded-lg shadow-2xl text-sm lg:text-lg relative z-10 transition duration-300 ease-in-out hover:scale-110">
                            QUERO COMPRAR
                        </button>
                    </div>
                </div>
            ...
            {/*MOBILE*/}
            <div className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center z-50 px-3 lg:hidden" style={{ background: 'rgba(0,0,0,0.7)' }}>
                ...
                <div className="flex items-center justify-between py-2">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col items-center mb-8">
                            <div className="bg-gold w-20 h-20 rounded-full flex justify-center items-center">
                                <img src={people} alt="icon" className="w-1/2" />
                            </div>
