    ...
    return (
        <div>
            <Modal isOpen={openModal}>
                <div className="flex flex-col justify-center items-center p-4 lg:p-14 bg-gold rounded-xl text-center w-full h-full">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center lg:justify-start lg:gap-5 mt-5">
                        <button className="w-20 lg:full mt-4 px-4 lg:px-10 py-4 bg-white text-black rounded-full text-center flex justify-center items-center" onClick={() => setOpenModal(false)}>Sim</button>
                        <button className="w-20 lg:full mt-4 px-4 lg:px-10 py-4 bg-white text-black rounded-full text-center flex justify-center items-center" onClick={handleNoClick}>Não</button>
                    </div>
                </div>
            </Modal>
        </div>
